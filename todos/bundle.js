...
var allTodos = exports.allTodos = function allTodos(state) {
  var arr = [];
  Object.keys(state.todos).forEach(function (key, idx) {
...
var _todo_actions = __webpack_require__(5);
...
var _root_reducer = __webpack_require__(47);
...
var configureStore = exports.configureStore = function configureStore() {
    ...
    return (0, _redux.createStore)(_root_reducer2.default, state, (0, _redux.applyMiddleware)(_reduxLogger2.default));
};
...
var _todos_reducer = __webpack_require__(48);
...
var todosReducer = function todosReducer() {
  ...
  switch (action.type) {
    ...
    case _todo_actions.RECEIVE_TODO:
      ...
      return (0, _merge2.default)({}, state, newState2);
...
*/
var aa=__webpack_require__(1),m=__webpack_require__(18),A=__webpack_require__(3),B=__webpack_require__(2),ca=__webpack_require__(19),da=__webpack_require__(20),ea=__webpack_require__(21),ha=__webpack_require__(22),ia=__webpack_require__(23),C=__webpack_require__(6);
...
var _todo_list_container = __webpack_require__(62);
...
var todoList = exports.todoList = function todoList(props) {
  ...
  function cb(el) {
    return _react2.default.createElement(_todo_list_item2.default, { todo: el, removeTodo: props.removeTodo });
  }
...
var TodoListItem = function (_React$Component) {
  ...
  function TodoListItem(props) {
    ...
    _this.removeTodo = _this.props.removeTodo;
  ...
  _createClass(TodoListItem, [{
    ...
    value: function render() {
      return _react2.default.createElement(
        ...
        _react2.default.createElement(
          'button',
          { onClick: this.callback(this.props.todo) },
          'Remove'
        )
      );
    }
...
var TodoForm = function (_React$Component) {
  ...
  _createClass(TodoForm, [{
    ...
    value: function callback(todo) {
      ...
      return function () {
        return _this2.receiveTodo(todo);
      };
    }
  }, {
    key: 'render',
      ...
      return _react2.default.createElement(
        ...
        _react2.default.createElement(
          ...
          _react2.default.createElement(
            ...
            null,
            'Body',
            _react2.default.createElement('input', { id: 'body', type: 'text' })
          ),
          _react2.default.createElement('input', { id: 'id', type: 'hidden', value: this.uniqueId() }),
